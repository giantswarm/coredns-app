...
require (
	...
	github.com/cert-manager/cert-manager v1.16.0 // indirect
	...
	github.com/giantswarm/cluster-standup-teardown v1.25.5 // indirect
	...
	github.com/giantswarm/releases/sdk v0.6.0 // indirect
