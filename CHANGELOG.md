...
- Updated coredns to upstream version [1.8.1](https://coredns.io/2021/01/20/coredns-1.8.1-release/) (including changes introduced in version [1.8.0](https://coredns.io/2020/10/22/coredns-1.8.0-release/)).
...
[Unreleased]: https://github.com/giantswarm/coredns-app/compare/v1.3.0...HEAD
