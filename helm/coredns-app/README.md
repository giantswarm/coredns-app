...
![Version: 1.32.0](https://img.shields.io/badge/Version-1.32.0-informational?style=flat-square) ![AppVersion: 1.14.6](https://img.shields.io/badge/AppVersion-1.14.6-informational?style=flat-square)
...
| configmap.cache | int | `30` | DEPRECATED: use coredns.<zone>.cache.success.ttl. Success cache TTL (seconds), applied to every zone that leaves its own success TTL unset. |
...
| coredns | object | `{"additionalZones":[],"cluster":{"cache":{"denial":{"capacity":9984,"minTTL":null,"ttl":5},"disable":{"denial":null,"denialZones":[],"success":null,"successZones":[]},"keepttl":false,"prefetch":{"amount":null,"duration":null,"percentage":null},"serveStale":{"duration":null,"enabled":false,"refreshMode":null,"verifyTimeout":null},"servfail":{"duration":null},"success":{"capacity":9984,"minTTL":null,"ttl":null},"ttl":null,"zones":[]},"domains":null,"kubernetes":{"apiserverBurst":null,"apiserverMaxInflight":null,"apiserverQPS":null,"endpoint":null,"endpointPodNames":false,"fallthrough":false,"fallthroughZones":[],"ignoreEmptyService":false,"kubeconfig":{"context":null,"path":null},"labels":null,"multicluster":[],"namespaceLabels":null,"namespaces":[],"noendpoints":false,"pods":"verified","startupTimeout":null,"tls":{"ca":null,"cert":null,"key":null},"ttl":null},"loadbalance":null,"log":null,"podCIDR":null,"serviceCIDR":null},"custom":"","public":{"autopath":"","cache":{"denial":{"capacity":9984,"minTTL":null,"ttl":5},"disable":{"denial":null,"denialZones":[],"success":null,"successZones":[]},"keepttl":false,"prefetch":{"amount":null,"duration":null,"percentage":null},"serveStale":{"duration":null,"enabled":false,"refreshMode":null,"verifyTimeout":null},"servfail":{"duration":null},"success":{"capacity":9984,"minTTL":null,"ttl":null},"ttl":null,"zones":[]},"forward":{"dohMethod":null,"except":[],"expire":null,"failfastAllUnhealthyUpstreams":false,"failover":[],"forceTCP":false,"healthCheck":null,"maxConcurrent":null,"maxConnectAttempts":null,"maxFails":null,"maxIdleConns":null,"next":[],"nextOnNodata":false,"policy":null,"preferUDP":false,"resolver":[],"tls":{"ca":null,"cert":null,"enabled":false,"key":null},"tlsServername":null,"to":[]},"loadbalance":null,"log":null}}` | CoreDNS Corefile configuration. Cache, log and loadbalance are configured per zone, so different zones can behave differently. A zone that omits cache falls back to the built-in defaults (success 9984 30 / denial 9984 5), with the success TTL falling back to the deprecated configmap.cache first; a zone that omits log/loadbalance falls back to the deprecated configmap.log / loadbalancePolicy, then to denial+error / round_robin. |
...
| coredns.cluster | object | `{"cache":{"denial":{"capacity":9984,"minTTL":null,"ttl":5},"disable":{"denial":null,"denialZones":[],"success":null,"successZones":[]},"keepttl":false,"prefetch":{"amount":null,"duration":null,"percentage":null},"serveStale":{"duration":null,"enabled":false,"refreshMode":null,"verifyTimeout":null},"servfail":{"duration":null},"success":{"capacity":9984,"minTTL":null,"ttl":null},"ttl":null,"zones":[]},"domains":null,"kubernetes":{"apiserverBurst":null,"apiserverMaxInflight":null,"apiserverQPS":null,"endpoint":null,"endpointPodNames":false,"fallthrough":false,"fallthroughZones":[],"ignoreEmptyService":false,"kubeconfig":{"context":null,"path":null},"labels":null,"multicluster":[],"namespaceLabels":null,"namespaces":[],"noendpoints":false,"pods":"verified","startupTimeout":null,"tls":{"ca":null,"cert":null,"key":null},"ttl":null},"loadbalance":null,"log":null,"podCIDR":null,"serviceCIDR":null}` | The cluster.local zone — in-cluster DNS served by the kubernetes plugin. |
| coredns.cluster.cache | object | `{"denial":{"capacity":9984,"minTTL":null,"ttl":5},"disable":{"denial":null,"denialZones":[],"success":null,"successZones":[]},"keepttl":false,"prefetch":{"amount":null,"duration":null,"percentage":null},"serveStale":{"duration":null,"enabled":false,"refreshMode":null,"verifyTimeout":null},"servfail":{"duration":null},"success":{"capacity":9984,"minTTL":null,"ttl":null},"ttl":null,"zones":[]}` | Cache plugin configuration for this zone (https://coredns.io/plugins/cache/). |
...
| coredns.cluster.cache.success | object | `{"capacity":9984,"minTTL":null,"ttl":null}` | Caching of positive (success) responses. |
...
| coredns.cluster.cache.success.ttl | string | `nil` | Max TTL for positive responses (seconds). Omit to fall back to the deprecated configmap.cache, then to 30. |
...
| coredns.cluster.loadbalance | string | `nil` | Load balancing policy. Omit to fall back to the deprecated loadbalancePolicy, then to round_robin. |
| coredns.cluster.log | string | `nil` | CoreDNS log classes for this zone. Omit to fall back to the deprecated configmap.log, then to denial+error. |
...
| coredns.public | object | `{"autopath":"","cache":{"denial":{"capacity":9984,"minTTL":null,"ttl":5},"disable":{"denial":null,"denialZones":[],"success":null,"successZones":[]},"keepttl":false,"prefetch":{"amount":null,"duration":null,"percentage":null},"serveStale":{"duration":null,"enabled":false,"refreshMode":null,"verifyTimeout":null},"servfail":{"duration":null},"success":{"capacity":9984,"minTTL":null,"ttl":null},"ttl":null,"zones":[]},"forward":{"dohMethod":null,"except":[],"expire":null,"failfastAllUnhealthyUpstreams":false,"failover":[],"forceTCP":false,"healthCheck":null,"maxConcurrent":null,"maxConnectAttempts":null,"maxFails":null,"maxIdleConns":null,"next":[],"nextOnNodata":false,"policy":null,"preferUDP":false,"resolver":[],"tls":{"ca":null,"cert":null,"enabled":false,"key":null},"tlsServername":null,"to":[]},"loadbalance":null,"log":null}` | The "." zone — external/public DNS served by the forward plugin. |
...
| coredns.public.cache.success | object | `{"capacity":9984,"minTTL":null,"ttl":null}` | Caching of positive (success) responses. |
...
| coredns.public.cache.success.ttl | string | `nil` | Max TTL for positive responses (seconds). Omit to fall back to the deprecated configmap.cache, then to 30. |
...
| coredns.public.loadbalance | string | `nil` | Load balancing policy. Omit to fall back to the deprecated loadbalancePolicy, then to round_robin. |
| coredns.public.log | string | `nil` | CoreDNS log classes for this zone. Omit to fall back to the deprecated configmap.log, then to denial+error. |
...
| image | object | `{"name":"giantswarm/coredns","registry":"gsoci.azurecr.io","tag":"1.14.6"}` | Container image for CoreDNS. |
| image.name | string | `"giantswarm/coredns"` | Image repository. |
| image.registry | string | `"gsoci.azurecr.io"` | Image registry. |
| image.tag | string | `"1.14.6"` | Image tag. |
